...
/*SF_DATA;ver:1.06;sub:START;pass:START;ps:flbk:Reflective/Diffuse,lico:1,lgpr:1,nrmq:1,limd:1,uamb:True,mssp:True,lmpd:False,lprd:False,rprd:False,enco:False,frtr:True,vitr:True,dbil:True,rmgx:True,rpth:1,hqsc:True,hqlp:False,tesm:0,blpr:0,bsrc:0,bdst:1,culm:0,dpts:2,wrdp:True,dith:0,ufog:True,aust:True,igpj:False,qofs:0,qpre:1,rntp:1,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,ofsf:0,ofsu:0,f2p0:False;n:type:ShaderForge.SFN_Final,id:3157,x:34222,y:32533,varname:node_3157,prsc:2|diff-8504-OUT,spec-7329-OUT,gloss-2765-OUT,normal-4283-RGB,amdfl-6236-OUT,amspl-7294-OUT;n:type:ShaderForge.SFN_Tex2d,id:5306,x:33149,y:31951,ptovrint:False,ptlb:Diffuse,ptin:_Diffuse,varname:_Diffuse,prsc:0,tex:9dc9fdbd3cea93c44933221447787600,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Slider,id:8450,x:33122,y:32553,ptovrint:False,ptlb:Specular_Intensity,ptin:_Specular_Intensity,varname:_Specular_Intensity,prsc:0,min:0,cur:0,max:2;n:type:ShaderForge.SFN_Slider,id:2765,x:33122,y:32692,ptovrint:False,ptlb:Glossiness,ptin:_Glossiness,varname:_Glossiness,prsc:0,min:0,cur:0,max:1;n:type:ShaderForge.SFN_Cubemap,id:6394,x:33015,y:32893,ptovrint:False,ptlb:Diffuse_Reflexion_Cubemap,ptin:_Diffuse_Reflexion_Cubemap,varname:_Diffuse_Reflexion_Cubemap,prsc:1,cube:590c96e6d90e8f94f89cf9f137ad44d7,pvfc:0|DIR-5350-OUT;n:type:ShaderForge.SFN_NormalVector,id:5350,x:32814,y:32893,prsc:2,pt:True;n:type:ShaderForge.SFN_Multiply,id:1573,x:33266,y:32893,varname:node_1573,prsc:2|A-6394-RGB,B-7725-OUT;n:type:ShaderForge.SFN_ViewReflectionVector,id:2715,x:33141,y:33352,varname:node_2715,prsc:2;n:type:ShaderForge.SFN_Multiply,id:7086,x:33765,y:33185,varname:node_7086,prsc:2|A-2544-RGB,B-1570-OUT;n:type:ShaderForge.SFN_Cubemap,id:2544,x:33498,y:33362,ptovrint:False,ptlb:Specular_Reflexion_Cubemap,ptin:_Specular_Reflexion_Cubemap,varname:_Specular_Reflexion_Cubemap,prsc:1,cube:590c96e6d90e8f94f89cf9f137ad44d7,pvfc:0|DIR-2715-OUT;n:type:ShaderForge.SFN_Slider,id:7725,x:32937,y:33120,ptovrint:False,ptlb:Diffuse_Reflexion_Factor,ptin:_Diffuse_Reflexion_Factor,varname:_Diffuse_Reflexion_Factor,prsc:0,min:0,cur:0,max:1;n:type:ShaderForge.SFN_Slider,id:1570,x:33311,y:33628,ptovrint:False,ptlb:Specular_Reflexion_Factor,ptin:_Specular_Reflexion_Factor,varname:_Specular_Reflexion_Factor,prsc:0,min:0,cur:0,max:1;n:type:ShaderForge.SFN_Tex2d,id:2540,x:33149,y:32326,ptovrint:False,ptlb:Specular,ptin:_Specular,varname:_Specular,prsc:0,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Color,id:6261,x:33149,y:32149,ptovrint:False,ptlb:Color,ptin:_Color,varname:_Color,prsc:0,glob:False,c1:0.1912451,c2:0.09066822,c3:0.9485294,c4:1;n:type:ShaderForge.SFN_Add,id:6236,x:33607,y:32946,varname:node_6236,prsc:2|A-1573-OUT,B-1948-OUT;n:type:ShaderForge.SFN_Slider,id:1948,x:33249,y:33198,ptovrint:False,ptlb:Diffuse_Reflexion_Intensity,ptin:_Diffuse_Reflexion_Intensity,varname:_Diffuse_Reflexion_Intensity,prsc:1,min:-0.5,cur:-0.1433418,max:0.5;n:type:ShaderForge.SFN_Multiply,id:7329,x:33434,y:32389,varname:node_7329,prsc:2|A-2540-RGB,B-8450-OUT;n:type:ShaderForge.SFN_Tex2d,id:4283,x:33501,y:32746,ptovrint:False,ptlb:Normal,ptin:_Normal,varname:_Normal,prsc:2,ntxv:3,isnm:True;n:type:ShaderForge.SFN_Multiply,id:7427,x:33790,y:32255,varname:node_7427,prsc:2|A-5306-RGB,B-6261-RGB,C-5306-A;n:type:ShaderForge.SFN_Blend,id:7294,x:33881,y:33385,varname:node_7294,prsc:2,blmd:15,clmp:True|SRC-2544-RGB,DST-1570-OUT;n:type:ShaderForge.SFN_Multiply,id:1371,x:33834,y:31842,varname:node_1371,prsc:2|A-5306-RGB,B-6364-OUT;n:type:ShaderForge.SFN_Add,id:8504,x:34252,y:32056,varname:node_8504,prsc:2|A-1371-OUT,B-7427-OUT;n:type:ShaderForge.SFN_OneMinus,id:6364,x:33724,y:32049,varname:node_6364,prsc:2|IN-5306-A;proporder:6261-5306-2540-8450-2765-6394-7725-1948-2544-1570-4283;pass:END;sub:END;*/

Shader "TGD/Metal/Carrosserie_ColorAlpha" {
    Properties {
        _Color ("Color", Color) = (0.1912451,0.09066822,0.9485294,1)
...
/////// Diffuse:
                ...
                float3 diffuse = (directDiffuse + indirectDiffuse) * ((_Diffuse_var.rgb*(1.0 - _Diffuse_var.a))+(_Diffuse_var.rgb*_Color.rgb*_Diffuse_var.a));
/// Final Color:
...
/////// Diffuse:
                ...
                float3 directDiffuse = max( 0.0, NdotL) * attenColor;
                fixed4 _Diffuse_var = tex2D(_Diffuse,TRANSFORM_TEX(i.uv0, _Diffuse));
                float3 diffuse = directDiffuse * ((_Diffuse_var.rgb*(1.0 - _Diffuse_var.a))+(_Diffuse_var.rgb*_Color.rgb*_Diffuse_var.a));
/// Final Color:
                float3 finalColor = diffuse + specular;
