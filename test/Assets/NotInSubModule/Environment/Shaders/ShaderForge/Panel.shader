...
/*SF_DATA;ver:1.06;sub:START;pass:START;ps:flbk:Diffuse,lico:1,lgpr:1,nrmq:1,limd:1,uamb:True,mssp:True,lmpd:False,lprd:False,rprd:False,enco:False,frtr:True,vitr:True,dbil:False,rmgx:True,rpth:1,hqsc:True,hqlp:False,tesm:0,blpr:0,bsrc:0,bdst:1,culm:0,dpts:2,wrdp:True,dith:0,ufog:True,aust:True,igpj:False,qofs:0,qpre:1,rntp:1,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,ofsf:0,ofsu:0,f2p0:False;n:type:ShaderForge.SFN_Final,id:3157,x:34060,y:32653,varname:node_3157,prsc:2|diff-9388-OUT,spec-7329-OUT,gloss-2765-OUT,normal-4283-RGB,emission-6680-OUT,amdfl-1573-OUT;n:type:ShaderForge.SFN_Tex2d,id:5306,x:33202,y:31826,ptovrint:False,ptlb:Diffuse,ptin:_Diffuse,varname:_Diffuse,prsc:0,tex:66bb156175038a941924f54917606424,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Slider,id:8450,x:33122,y:32553,ptovrint:False,ptlb:Specular_Intensity,ptin:_Specular_Intensity,varname:_Specular_Intensity,prsc:0,min:0,cur:0.1274278,max:2;n:type:ShaderForge.SFN_Slider,id:2765,x:33122,y:32692,ptovrint:False,ptlb:Glossiness,ptin:_Glossiness,varname:_Glossiness,prsc:0,min:0,cur:0.1342418,max:1;n:type:ShaderForge.SFN_NormalVector,id:5350,x:32814,y:32893,prsc:2,pt:True;n:type:ShaderForge.SFN_Multiply,id:1573,x:33698,y:33008,varname:node_1573,prsc:2|A-4567-RGB,B-7725-OUT;n:type:ShaderForge.SFN_Slider,id:7725,x:33159,y:33181,ptovrint:False,ptlb:Diffuse_Reflexion_Factor,ptin:_Diffuse_Reflexion_Factor,varname:_Diffuse_Reflexion_Factor,prsc:0,min:0,cur:0.1820976,max:1;n:type:ShaderForge.SFN_Tex2d,id:2540,x:33149,y:32326,ptovrint:False,ptlb:Specular,ptin:_Specular,varname:_Specular,prsc:0,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Color,id:6261,x:33202,y:32067,ptovrint:False,ptlb:Color,ptin:_Color,varname:_Color,prsc:0,glob:False,c1:0.9485294,c2:0.09066822,c3:0.09066822,c4:1;n:type:ShaderForge.SFN_Slider,id:330,x:32872,y:32021,ptovrint:False,ptlb:Lerp_Diffuse,ptin:_Lerp_Diffuse,varname:_Lerp_Diffuse,prsc:2,min:0,cur:0.7338513,max:1;n:type:ShaderForge.SFN_Lerp,id:9388,x:33602,y:31940,varname:node_9388,prsc:2|A-5306-RGB,B-6261-RGB,T-330-OUT;n:type:ShaderForge.SFN_Multiply,id:7329,x:33434,y:32389,varname:node_7329,prsc:2|A-2540-RGB,B-8450-OUT;n:type:ShaderForge.SFN_Tex2d,id:4283,x:33618,y:32741,ptovrint:False,ptlb:Normal,ptin:_Normal,varname:_Normal,prsc:2,ntxv:3,isnm:True;n:type:ShaderForge.SFN_Cubemap,id:4567,x:33235,y:32877,ptovrint:False,ptlb:Diffuse_Reflexion,ptin:_Diffuse_Reflexion,varname:_Diffuse_Reflexion,prsc:2,cube:590c96e6d90e8f94f89cf9f137ad44d7,pvfc:0|DIR-5350-OUT;n:type:ShaderForge.SFN_Multiply,id:6680,x:33620,y:32155,varname:node_6680,prsc:2|A-5306-RGB,B-9704-OUT;n:type:ShaderForge.SFN_Slider,id:9704,x:33309,y:32259,ptovrint:False,ptlb:Sell Illu,ptin:_SellIllu,varname:_SellIllu,prsc:2,min:0,cur:0,max:1;proporder:6261-5306-330-2540-8450-2765-4567-7725-4283-9704;pass:END;sub:END;*/
...
Shader "TGD/Panel" {
    Properties {
        ...
        _SellIllu ("Sell Illu", Range(0, 1)) = 0
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
...
////// Emissive:
                float3 emissive = (_Diffuse_var.rgb*_SellIllu);
/// Final Color:
