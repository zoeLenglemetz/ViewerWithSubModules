...
////// Specular:
                ...
                float3 indirectSpecular = (0 + (texCUBE(_Specular_Reflexion_Cubemap,viewReflectDirection).rgb*_Specular_Reflexion_Intensity));
